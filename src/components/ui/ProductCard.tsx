...
export function ProductCard({ product, onClick }: ProductCardProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "flex w-full cursor-pointer flex-col items-center gap-1.5 rounded-xl bg-card p-3 text-center shadow-sm transition-all hover:shadow-md active:scale-[0.98] lg:gap-2 lg:p-4",
