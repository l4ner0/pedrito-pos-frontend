...
function makeSale(id: string, datetime: string, items: SaleItem[], method: SaleMethod): Sale {
  return {
    id,
    datetime,
    items,
    ...
    method,
    total: parseFloat(items.reduce((s, i) => s + i.qty * i.unitPrice, 0).toFixed(2)),
  };
}

const todaySales: Sale[] = [
  makeSale("#0047", "20/06/2024 10:32", [
    { name: "Coca-Cola 500ml",  qty: 3, unitPrice: 1.50 },
    { name: "Doritos Nacho 40g", qty: 2, unitPrice: 2.50 },
  ], "Efectivo"),
  makeSale("#0046", "20/06/2024 10:18", [
    { name: "Leche Gloria 1L", qty: 2, unitPrice: 4.80 },
  ], "Tarjeta"),
  makeSale("#0045", "20/06/2024 09:55", [
    { name: "Pan de Molde Bimbo", qty: 1, unitPrice: 5.50 },
    { name: "Inca Kola 1.5L",     qty: 2, unitPrice: 3.80 },
    { name: "Yogurt Toni 200g",   qty: 3, unitPrice: 2.00 },
  ], "Efectivo"),
  makeSale("#0044", "20/06/2024 09:41", [
    { name: "Pringles Original",    qty: 1, unitPrice: 7.50 },
    { name: "Agua San Luis 625ml",  qty: 2, unitPrice: 1.00 },
  ], "Yape"),
  makeSale("#0043", "20/06/2024 09:22", [
    { name: "Inca Kola 1.5L", qty: 1, unitPrice: 3.80 },
  ], "Efectivo"),
  makeSale("#0042", "20/06/2024 09:05", [
    { name: "Detergente Ariel 500g", qty: 1, unitPrice: 8.50 },
    { name: "Jabón Bolívar 200g",    qty: 2, unitPrice: 3.00 },
  ], "Tarjeta"),
];

const weekSales: Sale[] = [
  ...todaySales,
  makeSale("#0041", "19/06/2024 18:47", [
    { name: "Yogurt Toni 200g",  qty: 2, unitPrice: 2.20 },
    { name: "Coca-Cola 500ml",   qty: 4, unitPrice: 1.50 },
    { name: "Jabón Bolívar 200g", qty: 2, unitPrice: 3.00 },
  ], "Tarjeta"),
  makeSale("#0040", "19/06/2024 17:30", [
    { name: "Manzana Roja kg", qty: 2, unitPrice: 3.50 },
  ], "Efectivo"),
  makeSale("#0039", "19/06/2024 16:12", [
    { name: "Inca Kola 1.5L",    qty: 2, unitPrice: 3.80 },
    { name: "Pan de Molde Bimbo", qty: 1, unitPrice: 5.50 },
  ], "Yape"),
  makeSale("#0038", "19/06/2024 15:05", [
    { name: "Agua San Luis 625ml",   qty: 3, unitPrice: 1.00 },
    { name: "Croissant Mantequilla", qty: 1, unitPrice: 2.00 },
  ], "Efectivo"),
  makeSale("#0037", "18/06/2024 13:48", [
    { name: "Pringles Original",     qty: 2, unitPrice: 7.50 },
    { name: "Detergente Ariel 500g", qty: 2, unitPrice: 8.50 },
  ], "Tarjeta"),
  makeSale("#0036", "18/06/2024 12:20", [
    { name: "Coca-Cola 500ml",  qty: 3, unitPrice: 1.50 },
    { name: "Doritos Nacho 40g", qty: 2, unitPrice: 2.50 },
  ], "Efectivo"),
];
...
const monthSales: Sale[] = [
  ...weekSales,
  makeSale("#0035", "16/06/2024 14:10", [
    { name: "Detergente Ariel 500g", qty: 2, unitPrice: 8.50 },
  ], "Yape"),
  makeSale("#0034", "15/06/2024 11:05", [
    { name: "Pan de Molde Bimbo",  qty: 1, unitPrice: 5.50 },
    { name: "Jabón Bolívar 200g",  qty: 1, unitPrice: 3.00 },
  ], "Efectivo"),
  makeSale("#0033", "14/06/2024 09:33", [
    { name: "Leche Gloria 1L",   qty: 3, unitPrice: 4.80 },
    { name: "Yogurt Toni 200g",  qty: 5, unitPrice: 2.20 },
  ], "Tarjeta"),
  makeSale("#0032", "13/06/2024 16:22", [
    { name: "Inca Kola 1.5L",   qty: 2, unitPrice: 3.80 },
    { name: "Coca-Cola 500ml",  qty: 3, unitPrice: 1.50 },
  ], "Efectivo"),
  makeSale("#0031", "12/06/2024 10:15", [
    { name: "Croissant Mantequilla", qty: 2, unitPrice: 2.00 },
    { name: "Agua San Luis 625ml",   qty: 2, unitPrice: 1.00 },
  ], "Yape"),
  makeSale("#0030", "10/06/2024 14:30", [
    { name: "Manzana Roja kg",  qty: 2, unitPrice: 3.50 },
    { name: "Doritos Nacho 40g", qty: 1, unitPrice: 2.50 },
  ], "Efectivo"),
];
